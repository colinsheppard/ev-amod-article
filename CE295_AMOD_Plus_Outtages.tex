...
The model is now spatially disaggregated, so the three PDE's characterizing the distribution of vehicles in charging, discharging, and idle states are indexed by $i$ for each node in the system. 
