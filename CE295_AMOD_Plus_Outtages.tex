...
% Next we consider the benefits and drawbacks of different fleet sizes. Nearly all demand for mobility and power can be served with a 40,000 vehicle fleet in the Extreme scenario, and a 15,000 vehicle fleet in the Moderate scneario. Figure \ref{fig:time_extreme_7500} shows the number of vehicles in each state in the Extreme outages scenario with 7500 vehicles. States include: in transit with and without passengers, charging, discharging, and idle.
